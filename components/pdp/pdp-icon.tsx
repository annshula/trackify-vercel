...
/**
 * One stroke icon per `feature_highlight.icon` choice in Shopify. The keys
 * mirror that metaobject field's allowed values (and
 * scripts/pdp-content/types.ts ICONS) — an unknown key renders a plain check
 * rather than nothing, so merchant typos never leave an empty slot.
 */
const PATHS: Record<string, React.ReactNode> = {
  ...
  travel: (
    <>
      ...
      <path d="M9 7V4h6v3M10 11v5M14 11v5" />
    </>
  ),
  clean: (
    <>
  ...
  hand: (
    <>
      ...
      <path d="M18 8a2 2 0 1 1 4 0v6a8 8 0 0 1-8 8h-2c-2.8 0-4.5-.9-5.9-2.4l-2.8-2.8a2 2 0 0 1 2.8-2.8L8 16" />
    </>
  ),
  feather: (
    <>
...
PATHS.fit = PATHS.ruler;
PATHS.ship = PATHS.truck;

export function PdpIcon({
  icon,
  size = 22,
  ...props
}: { icon: string | null; size?: number } & Omit<SVGProps<SVGSVGElement>, "name">) {
  return (
    <svg
      width={size}
      height={size}
