...
const VARIANTS: Record<Variant, string> = {
  primary:
    "bg-primary text-on-primary hover:bg-primary-hover active:scale-[0.985]",
...
export function ButtonLink({
  ...
  return (
    <Link
      ...
      {...props}
    >
      <LinkPendingContent>{children}</LinkPendingContent>
    </Link>
  );
}

function LinkPendingContent({ children }: { children: React.ReactNode }) {
